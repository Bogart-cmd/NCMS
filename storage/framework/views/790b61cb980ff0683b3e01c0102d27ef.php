        ...
        <div class="flex items-center gap-3">
            ...
            <div class="hidden md:flex items-center gap-2 px-2 py-1.5 bg-gray-50 rounded-lg">
                <div class="w-7 h-7 bg-[#168753] rounded-full flex items-center justify-center">
                    <span class="text-white font-semibold text-xs"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A', 0, 1))); ?></span>
                </div>
                <div class="text-xs">
                    <p class="font-medium text-gray-900"><?php echo e(auth()->user()->name ?? 'Admin'); ?></p>
                    <p class="text-gray-500 capitalize"><?php echo e(auth()->user()->usertype ?? 'admin'); ?></p>
                </div>
            </div>
        ...
        <div class="p-4">
            ...
            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg mb-4">
                <div class="w-12 h-12 bg-[#168753] rounded-full flex items-center justify-center">
                    <span class="text-white font-semibold text-lg"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A', 0, 1))); ?></span>
                </div>
                <div>
                    <p class="font-medium text-gray-900"><?php echo e(auth()->user()->name ?? 'Admin'); ?></p>
                    <p class="text-gray-500 capitalize"><?php echo e(auth()->user()->usertype ?? 'admin'); ?></p>
...
<?php /**PATH C:\xampp\htdocs\ncms_turn_over-main\resources\views/components/adminHeader.blade.php ENDPATH**/ ?>