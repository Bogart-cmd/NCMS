...
@endauth
<!-- adminSideColor -->
<div class="absolute right-0 top-44 z-40" id="notification"></div>
    ...
    <ul class="flex flex-col gap-y-8">
        ...
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
            <a href="{{route('register_admin')}}" class="flex justify-between w-full">
                <div>Student's List</div>
                <div class="rounded-full bg-red-600 w-6 text-center" id="total_number"></div>
            </a>
        </li>
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
        ...
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
            <a href="{{ route('#') }}">Manage NOLITC Update</a>
        </li>
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
            <a href="{{route('showScoreCard')}}">Update Score Cards</a>
        </li>
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
            <a href="#">Manage Partners</a>
        </li>
        <li class="px-10 text-md text-[#fff] hover:bg-slate-600 py-1 rounded">
